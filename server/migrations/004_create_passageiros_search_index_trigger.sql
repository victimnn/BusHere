...
BEGIN
    ...
    VALUES (NEW.nome_completo, 'Passenger', NEW.passageiro_id);
END;
...
BEGIN
    ...
    IF OLD.nome_completo <> NEW.nome_completo THEN
        ...
        WHERE item_type = 'Passenger' AND item_id = NEW.passageiro_id;
    END IF;
END;
...
BEGIN
    ...
    WHERE item_type = 'Passenger' AND item_id = OLD.passageiro_id;
END;
