...
async function insertSampleData() {
  ...
  try {
    // Inserir ônibus de exemplo
    await connection.execute(`
      INSERT IGNORE INTO Onibus (nome, placa, modelo, marca, ano_fabricacao, capacidade, quilometragem, status_onibus_id) VALUES
    ...
    await connection.execute(`
      INSERT IGNORE INTO Rotas (codigo_rota, nome, descricao, origem_descricao, destino_descricao, distancia_km, tempo_viagem_estimado_minutos, status_rota_id) VALUES
    ...
    await connection.execute(`
      INSERT IGNORE INTO Passageiros (nome_completo, cpf, email, senha_hash, telefone, data_nascimento, logradouro, numero_endereco, bairro, cidade, uf, cep, tipo_passageiro_id) VALUES
